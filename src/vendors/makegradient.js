...
`,Lt={mesh:0,aurora:1,grainy:2,"deep-sea":3,holographic:4,impasto:5,spectral:6,fractal:7};class he{constructor(e){if(R(this,"container"),R(this,"renderer"),R(this,"gl"),R(this,"program"),R(this,"mesh"),R(this,"animationId",0),R(this,"lastFrameTime",0),R(this,"time",0),R(this,"speed",1),R(this,"resizeObserver",null),R(this,"fixedSize"),R(this,"observeResize"),typeof e.container=="string"){const n=document.querySelector(e.container);if(!n)throw new Error(`Container not found: ${e.container}`);this.container=n}else this.container=e.container;this.renderer=new ke({alpha:!1,dpr:e.dpr??.75,preserveDrawingBuffer:!1}),this.gl=this.renderer.gl,this.fixedSize=e.fixedSize??null,this.observeResize=e.observeResize??!this.fixedSize,this.time=e.initialTime??0,this.container.appendChild(this.gl.canvas),this.gl.canvas.style.width="100%",this.gl.canvas.style.height="100%",this.gl.canvas.style.display="block";const i=new Rt(this.gl);this.program=new ze(this.gl,{vertex:kt,fragment:Ot,uniforms:{uTime:{value:0},uColor1:{value:new D(0,0,0)},uColor2:{value:new D(0,0,0)},uColor3:{value:new D(0,0,0)},uColor4:{value:new D(0,0,0)},uColor5:{value:new D(0,0,0)},uNoiseStrength:{value:.2},uMode:{value:0}}}),this.mesh=new Dt(this.gl,{geometry:i,program:this.program}),this.updateUniforms(e.colors,e.mode,e.noiseStrength),this.program.uniforms.uTime.value=this.time,this.resize=this.resize.bind(this),this.resize(),this.observeResize&&(this.resizeObserver=new ResizeObserver(this.resize),this.resizeObserver.observe(this.container)),this.update=this.update.bind(this),e.autoStart??!0?this.start():this.renderFrame({time:this.time})}updateUniforms(e,i,n){const r=[...e.map(a=>this.toRgb(a))];for(;r.length<5;)r.push([0,0,0]);const l=this.program.uniforms;l.uColor1.value.set(r[0][0],r[0][1],r[0][2]),l.uColor2.value.set(r[1][0],r[1][1],r[1][2]),l.uColor3.value.set(r[2][0],r[2][1],r[2][2]),l.uColor4.value.set(r[3][0],r[3][1],r[3][2]),l.uColor5.value.set(r[4][0],r[4][1],r[4][2]),l.uNoiseStrength.value=n,l.uMode.value=Lt[i]||0}toRgb(e){return Array.isArray(e)?e:this.hexToRgb(e)}hexToRgb(e){e=e.replace("#","");const i=parseInt(e.substring(0,2),16)/255,n=parseInt(e.substring(2,4),16)/255,s=parseInt(e.substring(4,6),16)/255;return[i,n,s]}resize(){if(this.fixedSize){this.renderer.setSize(this.fixedSize.width,this.fixedSize.height);return}this.container&&this.renderer.setSize(this.container.clientWidth,this.container.clientHeight)}setSpeed(e){this.speed=e}getCanvas(){return this.gl.canvas}getCurrentTime(){return this.time}setTime(e){this.time=e,this.program.uniforms.uTime.value=this.time}setFixedSize(e,i){this.fixedSize={width:e,height:i},this.resize()}renderFrame(e={}){typeof e.width=="number"&&typeof e.height=="number"&&this.setFixedSize(e.width,e.height),typeof e.time=="number"&&this.setTime(e.time),this.renderer.render({scene:this.mesh})}update(e){if(this.animationId=requestAnimationFrame(this.update),typeof e!="number")return;if(!this.lastFrameTime){this.lastFrameTime=e;return}const i=e-this.lastFrameTime;i<1e3/30||(this.lastFrameTime=e,this.time+=Math.min(i,100)*6e-4*this.speed,this.program.uniforms.uTime.value=this.time,this.renderer.render({scene:this.mesh}))}start(){this.animationId||this.update()}stop(){this.animationId&&(cancelAnimationFrame(this.animationId),this.animationId=0,this.lastFrameTime=0)}dispose(){var e;this.stop(),(e=this.resizeObserver)==null||e.disconnect(),this.container&&this.gl.canvas.parentNode===this.container&&this.container.removeChild(this.gl.canvas)}}function oe(t,e={}){if(typeof window>"u")return;const i={event:"lumina_event",event_name:t,...e},n=window;if(Array.isArray(n.dataLayer)&&n.dataLayer.push(i),typeof n.clarity=="function")try{n.clarity("event",t)}catch{}}window.LuminaGradient={init:t=>{const e=new he(t);return oe("embed_init",{source:"embed",kind:"manual",mode:t.mode||"mesh"}),e}},document.addEventListener("DOMContentLoaded",()=>{document.querySelectorAll("[data-lumina-gradient]").forEach(e=>{const i=e.getAttribute("data-colors"),n=e.getAttribute("data-mode"),s=e.getAttribute("data-noise"),r=e.getAttribute("data-speed");if(i)try{const l=JSON.parse(i),a=n||"mesh",h=new he({container:e,colors:l,mode:a,noiseStrength:s?parseFloat(s):.2});r&&h.setSpeed(parseFloat(r)),oe("embed_init",{source:"embed",kind:"auto",mode:a})}catch(l){console.error("LuminaGradient: Invalid configuration",l)}})})})();
